...
basado en la lógica de segundo orden y de una serie de procedimientos que
recorren el árbol sintáctico para generar una serie de condiciones y operadores
de un problema de planificación STRIPS, expresado en lenguaje PDDL.

Se modelaron y solucionaron problemas de distintos dominios y tamaños a modo de
probar la efectividad de un planificador basado en SAT para resolver los
problemas traducidos. Los resultados fueron satisfactorios para problemas de
tamaño moderado: el planificador logró resolver la mayoría de ellos en menos de
cinco minutos.

Parte de este trabajo fue presentado en la Conferencia Internacional de Planificación
(ICAPS) en el año 2011, y los investigadores del área han
reconocido que los dominios generados por la herramienta pueden ser de interés
práctico, pues se conocen sus propiedades formales y es posible estudiarlos a
fondo para descubrir mejores heurísticas y optimizaciones para los
planificadores.
