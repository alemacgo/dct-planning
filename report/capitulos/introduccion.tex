...
% @A no esta explicado bien K-col ningún par de vértices conectados con un arco
...
% O le quitamos mayus a NP o a PH + Ph en negritas
...
% Acronimo afuera en bold y la explicacion adentrp
...
% ; o . y segido. Luego el planificador se encarga de
...
%No pondria la motivacion sino la ventaja
...
% Enfoque que sea independiente del domino... o enfoque independiente del dominio
...
%, asegurando que la complejidad del problema
%resultante no será mayor a la del problema original.
...
%fundamentacion es muy caiman.... creo que base suena mejor
