...
\midrule
\multicolumn{5}{@{}l}{\footnotesize\textsc{Sat}: $\pwin=[n+5,n+6]$} \\
\midrule
...
\caption[Resultados de M]{Resultados de M.
En cada tipo de problema, la tabla muestra el número de instancias resueltas
