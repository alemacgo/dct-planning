...
% No pondriía clasifica sino: determina el poder de expresiovidad de los distintos tipos de logica
...
% an de acciones suena raro... suena mejor secuencia de acciones
...
% Se llama strips a los problema de planidficacion :S?!
...
% No se considera el fragmento mas simple de pddl porque usamos el forall para hacer pH
...
%No son conjuntos de precondiciones... la tumpla tiene "el" conjunto de precondiciones
% y lo de condiciones que deben ser ciertas bla bla lo pondria entre parentesis... me parece
% mas facil de leer
...
% I es el estado inicial, y este es subconjunto de C no? y lo mismo para F
...
por ejemplo,
% Cambiaria sobremesa(1) por sobremesa(Bloque1) para que se entienda mas
...
% LAS formulas que ... SON descritas
