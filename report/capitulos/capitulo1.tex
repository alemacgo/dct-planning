...
una tupla $a = \tup{pre^+, pre^-, ef^+, ef^-}$ que contiene los conjuntos de
precondiciones positivas y negativas, o condiciones que deben ser ciertas y
falsas respectivamente para poder aplicar la acción; y los conjuntos de efectos
...
especificados por el conjunto de condiciones que son verdaderas en ellos.
