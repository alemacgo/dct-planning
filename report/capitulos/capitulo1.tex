...
%! trabajos previos?
%Finalmente, se expondrán trabajos 
...
Sólo se considerará en el resto del trabajo las fórmulas sin variables libres,
...
Puede verificarse mediante semántica formal si $\A\models\Phi$, donde $\Phi$
