...
(define (domain qbfae)
	...
	(:action establish_soexist_r
		...
		:effect	(and (not (holds_forall_24  max)) (holds_so-exists_r)  (not (proof))
				...
				(forall (?ivDel0) (not (holds_or_8 ?ivDel0)))
				(forall (?ivDel0) (not (holds_forall_24 ?ivDel0)))
				(forall (?ivDel0 ?ivDel1) (not (holds_or_22 ?ivDel0 ?ivDel1)))
				(forall (?ivDel0) (not (holds_or_20 ?ivDel0)))
				(forall (?ivDel0 ?ivDel1) (not (holds_and_21 ?ivDel0 ?ivDel1)))
				(forall (?ivDel0) (not (holds_and_15 ?ivDel0)))
				(forall (?ivDel0) (not (holds_and_19 ?ivDel0)))
				(forall (?ivDel0) (not (holds_and_4 ?ivDel0)))
				(forall (?ivDel0) (not (holds_and_7 ?ivDel0)))
				(forall (?ivDel0) (not (holds_exists_23 ?ivDel0))))
	)
